...
package teste.leitura_api_ibm_produtos_0_1;
...
/**
 * Job: LEITURA_API_IBM_PRODUTOS Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class LEITURA_API_IBM_PRODUTOS implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "LEITURA_API_IBM_PRODUTOS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LEITURA_API_IBM_PRODUTOS.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LEITURA_API_IBM_PRODUTOS.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XQgHl47m6+6OYeGk9faSZOxj/mAC1WWGF3tMbw==");
		...
		Object source_tFileInputExcel_1 = "//fsprd02n/comum/wellik/NRBA-BAIRRO/BA/BA.xlsx";
 ...
 */
    ...
    public static void main(String[] args){
        final LEITURA_API_IBM_PRODUTOS LEITURA_API_IBM_PRODUTOSClass = new LEITURA_API_IBM_PRODUTOS();

        int exitCode = LEITURA_API_IBM_PRODUTOSClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LEITURA_API_IBM_PRODUTOS.class.getClassLoader().getResourceAsStream("teste/leitura_api_ibm_produtos_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LEITURA_API_IBM_PRODUTOS.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LEITURA_API_IBM_PRODUTOS");
        }
...
/************************************************************************************************
 *     31921 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 de Março de 2022 21h51min24s BRT
 ************************************************************************************************/