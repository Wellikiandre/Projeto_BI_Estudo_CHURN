...
package teste.job_execucao_bi_2_horas_0_1;
...
/**
 * Job: JOB_Execucao_BI_2_Horas Purpose: <br>
 * Description: Wellikiandre <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class JOB_Execucao_BI_2_Horas implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "JOB_Execucao_BI_2_Horas";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				JOB_Execucao_BI_2_Horas.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(JOB_Execucao_BI_2_Horas.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_TESTE_JOB_Execucao_BI_2_Horas = new byte[0];
    static byte[] commonByteArray_TESTE_JOB_Execucao_BI_2_Horas = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TESTE_JOB_Execucao_BI_2_Horas) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		teste.start_cargas_0_1.START_CARGAS childJob_tRunJob_1 = new teste.start_cargas_0_1.START_CARGAS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		teste.start_fatos_0_1.START_FATOS childJob_tRunJob_2 = new teste.start_fatos_0_1.START_FATOS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		teste.start_dimensoes_0_1.START_DIMENSOES childJob_tRunJob_3 = new teste.start_dimensoes_0_1.START_DIMENSOES();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		teste.implentacao_regra_negocio_0_1.IMPLENTACAO_REGRA_NEGOCIO childJob_tRunJob_8 = new teste.implentacao_regra_negocio_0_1.IMPLENTACAO_REGRA_NEGOCIO();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		teste.start_disparador_email_0_1.Start_Disparador_Email childJob_tRunJob_5 = new teste.start_disparador_email_0_1.Start_Disparador_Email();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		teste.start_powerbi_0_1.START_PowerBI childJob_tRunJob_6 = new teste.start_powerbi_0_1.START_PowerBI();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		teste.start_whatsapp_0_1.Start_whatsapp childJob_tRunJob_7 = new teste.start_whatsapp_0_1.Start_whatsapp();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		teste.leitura_api_ibm_produtos_0_1.LEITURA_API_IBM_PRODUTOS childJob_tRunJob_4 = new teste.leitura_api_ibm_produtos_0_1.LEITURA_API_IBM_PRODUTOS();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final JOB_Execucao_BI_2_Horas JOB_Execucao_BI_2_HorasClass = new JOB_Execucao_BI_2_Horas();

        int exitCode = JOB_Execucao_BI_2_HorasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = JOB_Execucao_BI_2_Horas.class.getClassLoader().getResourceAsStream("teste/job_execucao_bi_2_horas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JOB_Execucao_BI_2_Horas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JOB_Execucao_BI_2_Horas");
        }
...
/************************************************************************************************
 *     77908 characters generated by Talend Open Studio for Data Integration 
 *     on the 26 de Março de 2022 21h51min26s BRT
 ************************************************************************************************/